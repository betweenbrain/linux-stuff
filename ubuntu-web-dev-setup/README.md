...
5. Gedit themes - https://github.com/mig/gedit-themes
    ...
    `$ git clone https://github.com/mig/gedit-themes.git ~/.gnome2/gedit`<br>
    `$ cd ~/.gnome2/gedit/gedit-themse`<br>
    `$ install.sh`
...
- PhpStorm from http://www.jetbrains.com/ (Yes, you need to pay for it. The shock and horror!)
- Kxb CD / DVD creator
- XVidCap
- AcidRip
- LibreOffice
